...
<body class="bg-neutral-900 text-white min-h-screen">
    ...
    <div class="max-w-5xl mx-auto px-6 py-10">
        ...
        <p class="text-white mb-6">
            This hall contains 500 Standard seats and VIP. BOX seating is available only on request via the admin, use the Contact form to inquire about special seating arrangements.
        </p>
