...
$stmt = $pdo->prepare("
    SELECT b.bookingID, b.bookingDate, b.totalAmount, s.showingDate, s.showingTime,
...
$stmt2 = $pdo->prepare("
    SELECT st.tierName, CONCAT(s.seatRow, s.seatNumber) AS seatLabel
    ...
    <div class="max-w-4xl mx-auto px-6 py-10">
        ...
        <div class="bg-white rounded shadow p-6 mb-6">
            ...
            <div class="flex flex-wrap gap-2 mb-2">
                ...
                ?>
                    <span class="px-2 py-1 rounded text-white font-semibold <?= $color ?>">
                        <?= htmlspecialchars($s['seatLabel']) ?> (<?= htmlspecialchars($s['tierName']) ?>)
                    </span>
                <?php endforeach; ?>
            </div>
